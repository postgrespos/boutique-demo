...
rpc_requests_total = Counter(
    'recommendationservice_rpc_requests_total',
    'Total number of gRPC requests processed, by method and status.',
    ['method', 'status'])

rpc_duration_seconds = Histogram(
    'recommendationservice_rpc_duration_seconds',
    'Latency of gRPC requests in seconds, by method.',
    ['method'])

recommendations_returned = Histogram(
    'recommendationservice_recommendations_returned',
    'Number of product recommendations returned per ListRecommendations call.',
